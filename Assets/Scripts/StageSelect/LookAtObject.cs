...
namespace TeamProject
{
    ...
    public class LookAtObject : MonoBehaviour
    {
        ...
        [Header("移動時間の倍率"), Min(0)]
        public float m_SwingTimeRatio;
        ...
        //更新用
        public void LookAtObjectUpdate()
        {
            ...
            switch (m_TargetMoveState)
            {
                ...
                case TARGET_MOVESTATE.PREVSTAGE:
                    ...
                    //ウェイポイント間の移動時間を代入
                    m_Back_SwingTime = m_WP.PrevWayPointDistance() / m_SwingTimeRatio;
